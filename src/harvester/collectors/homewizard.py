...
class HomewizardP1Collector(BaseCollector):
    ...
    METRIC_MAPPINGS: ClassVar[tuple[MetricMapping, ...]] = (
        ...
        MetricMapping(
            "power_w",
            "homewizard_active_power_total_watts",
            "Active power (total) in watts",
        ),
        MetricMapping(
            "power_l1_w",
            "homewizard_active_power_watts",
        ...
        # --- Voltage (Volts) ---
        MetricMapping(
            "voltage_l1_v", "homewizard_voltage_volts", "Voltage in volts", phase="L1"
        ),
        MetricMapping(
            "voltage_l2_v", "homewizard_voltage_volts", "Voltage in volts", phase="L2"
        ),
        MetricMapping(
            "voltage_l3_v", "homewizard_voltage_volts", "Voltage in volts", phase="L3"
        ),
        # --- Current (Amps) ---
        MetricMapping(
        ...
        MetricMapping(
            "current_l1_a", "homewizard_current_amps", "Current in amps", phase="L1"
        ),
        MetricMapping(
            "current_l2_a", "homewizard_current_amps", "Current in amps", phase="L2"
        ),
        MetricMapping(
            "current_l3_a", "homewizard_current_amps", "Current in amps", phase="L3"
        ),
        # --- Tariff ---
        ...
        MetricMapping(
            ...
            "homewizard_voltage_swell_total",
            "Voltage swell count",
            MetricType.COUNTER,
            phase="L1",
        ),
    ...
    def _collect_mapped_metrics(
        ...
        for mapping in self.METRIC_MAPPINGS:
            ...
            try:
                labels = (
                    {**base_labels, "phase": mapping.phase}
                    if mapping.phase
                    else base_labels
                )
                out.append(
